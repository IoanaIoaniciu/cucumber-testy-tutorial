...
import com.sdl.selenium.web.form.*;
...
public class PreferencesWindow {
    ...
    private Button clickSaveButton = new Button().setText("Save").setContainer(window);
    private Button clickCloseButton = new Button().setText("Close").setContainer(window);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(preferencesWindow.clickCloseButton.getPath());
    }
